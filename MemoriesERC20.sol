...
contract sGRAV is ERC20Permit, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("sGRAV", "MEMO", 9) ERC20Permit() {
    ...
    /**
        @notice increases sGRAV supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess sGRAV
